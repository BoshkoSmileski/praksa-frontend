...
const statusConfig: Record<ThesisStatus, { label: string; classes: string }> = {
  ...
  MENTOR_REQUESTED_CHANGES:  { label: 'Revision Requested',      classes: 'bg-orange-100 text-orange-800 ring-orange-200 dark:bg-orange-950 dark:text-orange-200 dark:ring-orange-900' },
  ...
  PENDING_ARCHIVE_VALIDATION:       { label: 'Awaiting Archive',       classes: 'bg-amber-100 text-amber-800 ring-amber-200 dark:bg-amber-950 dark:text-amber-200 dark:ring-amber-900' },
  APPLICATION_REJECTED_BY_ARCHIVE:  { label: 'Rejected by Archive',    classes: 'bg-red-100 text-red-800 ring-red-200 dark:bg-red-950 dark:text-red-200 dark:ring-red-900' },
  PENDING_SERVICE_VALIDATION:       { label: 'Awaiting Service',       classes: 'bg-amber-100 text-amber-800 ring-amber-200 dark:bg-amber-950 dark:text-amber-200 dark:ring-amber-900' },
  APPLICATION_REJECTED_BY_SERVICE:  { label: 'Rejected by Service',    classes: 'bg-red-100 text-red-800 ring-red-200 dark:bg-red-950 dark:text-red-200 dark:ring-red-900' },
